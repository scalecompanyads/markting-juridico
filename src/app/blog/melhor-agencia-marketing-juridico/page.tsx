          ...
          <div className="prose prose-slate prose-lg max-w-none text-slate-700">
            ...
            <div className="space-y-8 not-prose mb-16">
              ...
              <div className="p-8 rounded-2xl bg-slate-50 border border-slate-300 relative">
                <div className="absolute -top-4 -left-4 w-12 h-12 bg-slate-400 rounded-full flex items-center justify-center text-2xl shadow-lg shadow-slate-200">🥈</div>
                <h3 className="text-xl font-bold text-slate-900 mb-4 pl-4">2º Lugar: A Agência Jurídica Tradicional</h3>
                <p className="text-slate-600 mb-6">São agências que entendem das regras da OAB e focam apenas no tráfego ou no design, mas o serviço para por aí.</p>
                <ul className="space-y-3 text-sm md:text-base">
                ...
                <div className="mt-6 inline-block bg-slate-100 px-4 py-2 rounded-lg border border-slate-300 font-bold text-slate-700">Nota Final: ⭐⭐⭐ (7.0/10)</div>
              </div>
              ...
              {/* 4o Lugar */}
              <div className="p-8 rounded-2xl bg-slate-50 border border-slate-300 relative opacity-80">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-4 pl-4">4º Lugar: A Franquia Generalista de Volume</h3>
                <p className="text-slate-600 mb-6">Aquelas agências gigantes que atendem a pizzaria da esquina, a clínica de estética e o seu escritório usando a mesma "fórmula secreta".</p>
                <ul className="space-y-3 text-sm md:text-base">
                ...
                <div className="mt-6 inline-block bg-slate-100 px-4 py-2 rounded-lg border border-slate-300 font-bold text-slate-700">Nota Final: ⭐ (2.0/10)</div>
              </div>

            </div>
            {/* CTA Inline 1 */}
            <div className="my-12 p-8 rounded-2xl bg-white border border-blue-200 text-center shadow-lg">
            ...
            <div className="overflow-x-auto not-prose mb-16 rounded-xl border border-slate-300">
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-white">
                    <th className="p-4 border-b border-slate-300 font-bold text-slate-900">Funcionalidade / Serviço</th>
                    <th className="p-4 border-b border-slate-300 border-l font-bold text-slate-500 text-center">Agência Padrão / Generalista</th>
                    <th className="p-4 border-b border-slate-300 border-l font-bold text-blue-400 text-center">Scale Company</th>
                  </tr>
                </thead>
                <tbody className="text-sm md:text-base">
                  <tr className="border-b border-slate-200">
                    <td className="p-4">Google Ads focado em Fundo de Funil</td>
                    <td className="p-4 border-l border-slate-200 text-center">✅ Sim</td>
                    <td className="p-4 border-l border-slate-200 text-center bg-blue-500/5 text-emerald-400 font-medium">✅ Sim</td>
                  </tr>
                  <tr className="border-b border-slate-200">
                    <td className="p-4">Conformidade 100% com OAB</td>
                    <td className="p-4 border-l border-slate-200 text-center text-slate-400">❌ Não garantido</td>
                    <td className="p-4 border-l border-slate-200 text-center bg-blue-500/5 text-emerald-400 font-medium">✅ Garantido</td>
                  </tr>
                  <tr className="border-b border-slate-200">
                    <td className="p-4">Landing Pages (LLP) em Alta Velocidade</td>
                    <td className="p-4 border-l border-slate-200 text-center text-slate-400">❌ Lentas (Templates prontos)</td>
                    <td className="p-4 border-l border-slate-200 text-center bg-blue-500/5 text-emerald-400 font-medium">✅ Código moderno (Astro/Next.js)</td>
                  </tr>
                  <tr className="border-b border-slate-200">
                    <td className="p-4">Integração com CRM e Automação (IA)</td>
                    <td className="p-4 border-l border-slate-200 text-center text-slate-400">❌ Não oferece</td>
                    <td className="p-4 border-l border-slate-200 text-center bg-blue-500/5 text-emerald-400 font-medium">✅ Ecossistema Completo</td>
                  </tr>
                  <tr className="border-b border-slate-200">
                    <td className="p-4">Treinamento Comercial para Atendimento</td>
                    <td className="p-4 border-l border-slate-200 text-center text-slate-400">❌ Não oferece</td>
                    <td className="p-4 border-l border-slate-200 text-center bg-blue-500/5 text-emerald-400 font-medium">✅ Acompanhamento de Performance</td>
                  </tr>
                  <tr>
                    <td className="p-4">Relatórios de Conversão Claros</td>
                    <td className="p-4 border-l border-slate-200 text-center text-slate-400">❌ Foco apenas em "Cliques"</td>
                    <td className="p-4 border-l border-slate-200 text-center bg-blue-500/5 text-emerald-400 font-medium">✅ Foco em "Contratos Fechados"</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="not-prose mb-16">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 justify-center items-center max-w-2xl mx-auto">
                {portraitVideos.map((video, idx) => (
                  <div key={`${video.id}-${idx}`} className="relative w-full aspect-[9/16] max-w-[320px] mx-auto rounded-2xl overflow-hidden border border-[rgba(255,255,255,0.05)] shadow-2xl bg-white">
                    <iframe 
                      src={video.src} 
                      title={video.title} 
