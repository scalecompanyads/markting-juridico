      ...
      <div className="container-page relative z-10">
        ...
        <div className="max-w-[800px] mx-auto text-center mb-16">
          ...
          <h2 className="section-title">
            Indicação não é modelo de negócio. <span>Previsibilidade sim.</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16 max-w-[1000px] mx-auto">
          ...
          <div className="bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.05)] rounded-2xl p-8 flex flex-col gap-4">
            <div className="text-[#3B82F6] font-mono text-sm tracking-widest font-bold mb-2">A MÉTRICA MAIS IMPORTANTE</div>
          ...
          <div className="bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.05)] rounded-2xl p-8 flex flex-col gap-4">
            <div className="text-[#3B82F6] font-mono text-sm tracking-widest font-bold mb-2">O EFEITO BOLA DE NEVE</div>
